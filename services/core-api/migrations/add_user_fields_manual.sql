-- Manual migration to add new user fields
-- Run this if Alembic migrations are not set up yet
-- Usage: docker exec -i sigmachain-db psql -U sigmachain -d sigmachain < backend/migrations/add_user_fields_manual.sql
